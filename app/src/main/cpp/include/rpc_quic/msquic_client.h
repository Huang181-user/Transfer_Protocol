#ifndef ZHIAUTH_MSQUIC_CLIENT_H
#define ZHIAUTH_MSQUIC_CLIENT_H
#include <msquic.h>
#include <string>
#include <vector>
#include <future>
...
public:
    ...
    // 🔥 CHUYỂN SANG DÙNG ASYNC ĐỂ PHÁ DEADLOCK JNI
    static bool send_vfs_async(const std::vector<uint8_t>& payload, uint32_t req_id);
