...
func StartDualFuseSubsystem(mountPoint, remoteBase string, tunnel *QuicTunnel) {
	...
	opts := &fs.Options{
		...
		MountOptions: fuse.MountOptions{
			...
			// 🔥 FIX BỆNH TREO THUNAR: Ép nhỏ Chunk Size và số luồng để UDP không bị sặc!
			MaxWrite:      32768, // Chỉ xin 32KB mỗi lần (~24 cục KCP)
			MaxBackground: 4,     // Khóa cứng tối đa 4 luồng đồng thời (Thay vì 128)
		},
	}
